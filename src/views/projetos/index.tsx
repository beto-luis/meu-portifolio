  ...
  return (
    <Flex
      ...
      <SimpleGrid columns={{ base: 1 }} spacing={'20'} mt={16} mb={16} mx={'auto'}>
        <Center display={{ md: "flex" }} py={5} flexDirection={'column'}>
            <Flex
              ...
              <Flex justify={'center'}>
                <Link target='_Blank' as={'a'} href={'https://main--fluffy-praline-f37cd8.netlify.app/'} variant='custom'>
                  <Image
                    ...
                    alt='Buscador de usuários do github'
                    _after={{
                      position: 'absolute',
                      transition: '0.2s',
                    }}
          ...
          <Flex justify={'center'}>
            <Link target='_Blank' as={'a'} href={'https://beto-luis.github.io/landing-page-com-grid-e-flex/'} variant='custom'>
              <Image
                ...
                alt='Landing page com flex e grid'
                _before={{
                  position: 'absolute',
                  transition: '0.2s',
                }}
          ...
          <Flex justify={'center'}>
            <Link target='_Blank' as={'a'} href={'https://beto-luis.github.io/Quest-JS-intermediario/'} variant='custom'>
              <Image
                ...
                h={'full'}
                src={'formulario.png'}
                alt='Formulário de preenchimento obrigatório'
                _before={{
                  position: 'absolute',
                  transition: '0.2s',
                }}
    ...
    <Flex justifyContent={'center'}
      ...
      </Flex><Tabs isFitted variant='enclosed' w={'90%'} my={'40px'}>
        <TabList mb='20px'>
        ...
        <TabPanels>
          <TabPanel>
            <Flex gap={'30'} direction={{ base: 'column', lg: 'row' }}>
              ...
              <Flex maxW={{base: '100%', lg: '50%' }} direction={'column'} color={useColorModeValue('gray.700', 'gray.50')} bg={useColorModeValue('green.100', 'green.600')} rounded={'md'} p={{ base: '4', lg: '8'}}>
                <Heading mb={'5'} textAlign={'center'} fontFamily={'poppins'} fontSize={'20px'}>
                  App Despesas Pessoais
                </Heading>
                <Text textAlign={'left'} fontFamily={'poppins'} fontSize={'16px'}>
